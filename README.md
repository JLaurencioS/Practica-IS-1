...
debajo de esto dos botones, uno cambia el color de fondo y el otro cambia la imagen del integrante y su descripcion,
por ultimo al cambiar el color de fondo salta un toast o mensaje con la hora y color del cambio.

Para visualizar la pagina se puede utilizar el siguiente link: https://practicau1.x10.mx/
o bien se puede descargar el repositorio y utilizar un IDE para verlo.

Si se requiere ayuda contactar con los autores mediante mensaje privado
